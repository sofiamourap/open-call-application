...
con.connect(function(err) {
  ...
  let sql =
  "CREATE TABLE `candidats` (`id` INT AUTO_INCREMENT,`full_name` varchar(255),`project` varchar(255),`email` varchar(255),`residency_id` INT,`status` BOOLEAN,PRIMARY KEY (`id`));CREATE TABLE `openCall` (`id` INT  AUTO_INCREMENT,`residency_name` varchar(255),`gallery_id` INT,`description` varchar(255),`status` BOOLEAN, PRIMARY KEY (`id`));CREATE TABLE `gallery` (`id` INT AUTO_INCREMENT,`name` varchar(255),`country` varchar(255),`city` varchar(255), PRIMARY KEY (`id`));";
